  ...
  return (
    <View style={styles.changePassword}>
      <View style={[styles.oldPassword, styles.passwordLayout]}>
        <Text style={[styles.oldPassword1, styles.textTypo]}>Old Password</Text>
        <View style={[styles.oldPasswordForm, styles.headerItemBorder]}>
          <Image
      ...
      <View style={[styles.newPassword, styles.passwordLayout]}>
        <Text style={[styles.oldPassword1, styles.textTypo]}>New Password</Text>
        <View style={[styles.oldPasswordForm, styles.headerItemBorder]}>
          <Image
            style={styles.systemIcon24pxpassword}
            contentFit="cover"
      ...
      <View style={[styles.newPasswordAgain, styles.passwordLayout]}>
        <Text style={[styles.oldPassword1, styles.textTypo]}>
          New Password Again
        </Text>
        <View style={[styles.oldPasswordForm, styles.headerItemBorder]}>
          <Image
