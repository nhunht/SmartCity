...
const NotificationActivity = () => {
  return (
    <View style={styles.notificationActivity}>
      <View style={[styles.list, styles.listFlexBox]}>
        <View style={styles.activityList01}>
          <Image
            style={styles.systemIcon24pxtransaction}
            contentFit="cover"
            source={require("../assets/system-icon24pxtransaction.png")}
          />
          <View
            style={[
              styles.transactionNikeAirZoomProdParent,
              styles.listFlexBox,
            ]}
          >
            <Text style={styles.transactionNikeAir}>
...
const styles = StyleSheet.create({
  ...
  transactionNikeAirZoomProdParent: {
    marginLeft: 12,
  },
  activityList01: {
    flexDirection: "row",
