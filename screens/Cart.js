  ...
  return (
    <View style={styles.cart}>
      <View style={[styles.product1, styles.productLayout]}>
        ...
        <Text style={[styles.nikeAirZoom, styles.yourCartTypo]}>
          Nike Air Zoom Pegasus 36 Miami
        </Text>
        <Text style={[styles.text, styles.textTypo1]}>$299,43</Text>
        <Image
      ...
      <View style={[styles.cuponForm, styles.cuponLayout]}>
        <View style={[styles.cuponFormChild, styles.items3Position]} />
        <Text style={[styles.enterCuponCode, styles.home1Clr]}>
          Enter Cupon Code
        </Text>
      ...
      <View style={[styles.totalPrice, styles.childBorder]}>
        <View style={[styles.parent, styles.groupLayout]}>
          ...
          <Text style={[styles.items3, styles.home1Clr]}>Items (3)</Text>
        </View>
        <View style={[styles.group, styles.groupLayout]}>
          <Text style={[styles.text4, styles.textPosition]}>$40.00</Text>
          <Text style={[styles.items3, styles.home1Clr]}>Shipping</Text>
        </View>
        <View style={[styles.container, styles.groupLayout]}>
          <Text style={[styles.text4, styles.textPosition]}>$128.00</Text>
          <Text style={[styles.items3, styles.home1Clr]}>Import charges</Text>
        </View>
      ...
      <View style={[styles.checkOutPrice, styles.checkOutPricePosition]}>
        <Text style={[styles.checkOut, styles.applyTypo]}>Check Out</Text>
      </View>
      <View style={[styles.header, styles.headerPosition]}>
        <View style={[styles.headerChild, styles.childPosition]} />
        <Text style={[styles.yourCart, styles.text1Position]}>Your Cart</Text>
      ...
      <View style={[styles.tabBartabBar, styles.tabBartabBarPosition]}>
        ...
        <View style={[styles.menu, styles.menuPosition]}>
          ...
          <View style={[styles.cart1, styles.homeLayout]}>
            <View style={[styles.headerChild, styles.childPosition]} />
            <Image
              style={[styles.systemIcon24pxhome, styles.iconLayout]}
              contentFit="cover"
            ...
            />
            <Text style={[styles.cart2, styles.home1Typo]}>Cart</Text>
      ...
      <View style={[styles.uiHomeIndicator, styles.tabBartabBarPosition]}>
        <View style={[styles.homeIndicator, styles.checkOutPricePosition]} />
      </View>
    </View>
  );
};
